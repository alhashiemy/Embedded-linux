...
static constexpr auto qt_meta_stringdata_CLASSTrafficLightENDCLASS = QtMocHelpers::stringData(
    "TrafficLight",
    "sendState",
    "",
    "state_string"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSTrafficLightENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSTrafficLightENDCLASS_t qt_meta_stringdata_CLASSTrafficLightENDCLASS = {
    {
        QT_MOC_LITERAL(0, 12),  // "TrafficLight"
        QT_MOC_LITERAL(13, 9),  // "sendState"
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 12)   // "state_string"
    },
    "TrafficLight",
    "sendState",
    "",
...
void TrafficLight::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendState((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &TrafficLight::sendState; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TrafficLight::sendState(QString _t1)
{
